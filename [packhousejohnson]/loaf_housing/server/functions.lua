...
local Webhook = "https://discord.com/api/webhooks/905905401722187787/gkCOo_UzJ-I9n7mUNpmJd-pbrMjDNOC0mv_sBRueGIanPjexYlNEymbfh1Q-rNU3ahyI" -- where logs are sent
    ...
    if houseid and itemtype and xPlayer and xPlayer.identifier and spawned_houses[houseid] then
        ...
        elseif itemtype == "items" then
            if xPlayer.canCarryItem(itemname, amount) then
                ...
                TriggerClientEvent('okokNotify:Alert', xPlayer.source, "ERROR", Strings["cant_carry"], 8000, 'error')
            end
        elseif itemtype == "weapons" then

...
RegisterServerEvent('origen_hud:updateCops')
...
RegisterServerEvent('origen_hud:syncCarLights')
...
RegisterServerEvent('origen_hud:nohud')
...
RegisterServerEvent('origen_hud:sihud')
